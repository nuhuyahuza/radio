...
<body>
				...
				<div class="modal-body p-4">
					...
					<form id="bookingForm" method="POST" action="javascript:void(0)">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="advertiserName" name="advertiser_name"
										required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="email" class="form-control" id="advertiserEmail"
										name="advertiser_email" required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="tel" class="form-control" id="advertiserPhone" name="advertiser_phone"
										required>
								</div>
							</div>
							<div class="col-md-6">
						...
						<div class="mb-3">
							...
							<textarea class="form-control" id="advertisementMessage" name="advertisement_message"
								rows="4" required placeholder="Describe your advertisement content..."></textarea>
						</div>
					</form>
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		// Prevent native form submit (use AJAX instead)
	...
	function submitBooking() {
		...
		// Build draft object (no server call yet)
		const start = new Date(selectedSlot.start);
		const end = new Date(selectedSlot.end);
		const draft = {
			slot: {
				id: document.getElementById('slotId').value,
				title: document.getElementById('slotDetails').querySelector('strong').textContent,
			...
			advertiser: {
				name: document.getElementById('advertiserName').value,
				email: document.getElementById('advertiserEmail').value,
				phone: document.getElementById('advertiserPhone').value,
				company: document.getElementById('companyName').value
			},
			message: document.getElementById('advertisementMessage').value
		};
		try {
		...
		// Navigate to summary page (will render from sessionStorage)
