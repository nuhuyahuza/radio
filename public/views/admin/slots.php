            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="text-muted me-3">Showing <span id="showingCount">0</span> of <span id="totalCount">0</span> slots</span>
            ...
            <form id="slotForm">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label for="slotStartTime" class="form-label">Start Time <span class="text-danger">*</span></label>
                            <input type="time" class="form-control" id="slotStartTime" required>
                        </div>
                        <div class="col-md-3">
                            <label for="slotEndTime" class="form-label">End Time <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="slotDescription" rows="3" placeholder="Optional description for this slot..."></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="generateSlotsForm">
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="genStartDate" class="form-label">Start Date <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="genStartDate" required>
                        </div>
                        <div class="col-md-6">
                            <label for="genEndDate" class="form-label">End Date <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="genEndDate" required>
                        </div>
                        <div class="col-md-6">
                            <label for="genStartTime" class="form-label">Start Time <span class="text-danger">*</span></label>
                            <input type="time" class="form-control" id="genStartTime" required>
                        </div>
                        <div class="col-md-6">
                            <label for="genEndTime" class="form-label">End Time <span class="text-danger">*</span></label>
                            <input type="time" class="form-control" id="genEndTime" required>
                        </div>
                        <div class="col-md-6">
                            <label for="genDuration" class="form-label">Slot Duration (minutes) <span class="text-danger">*</span></label>
    ...
    slots.forEach(slot => {
        ...
        if (dayElement) {
            ...
            if (!slotsContainer.querySelector('.slot-indicator')) {
                ...
                indicator.title = `${formatTime(slot.start_time)} - ${formatTime(slot.end_time)} ($${formatAmount(slot.price)})`;
...
document.getElementById('slotForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        if (data.success) {
            showAlert(editingSlotId ? 'Slot updated successfully' : 'Slot created successfully', 'success');
...
function performBulkAction(action, slotIds) {
    ...
    .then(data => {
        if (data.success) {
            showAlert(`${action.charAt(0).toUpperCase() + action.slice(1)}ed ${slotIds.length} slot(s) successfully`, 'success');
            selectedSlots = [];
            loadSlots();
            updateCalendar();
        } else {
