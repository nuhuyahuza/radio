			...
			<div class="d-flex justify-content-between align-items-center mb-4">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="dropdown-item" href="/admin/reports/export?type=bookings&format=excel">Excel</a>
						</li>
						<li>
							<hr class="dropdown-divider">
						</li>
						<li>
							<h6 class="dropdown-header">Revenue</h6>
						</li>
						...
						<li><a class="dropdown-item" href="/admin/reports/export?type=revenue&format=excel">Excel</a>
						</li>
						<li>
							<hr class="dropdown-divider">
						</li>
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div class="text-xs font-weight-bold text-success text-uppercase mb-1">
										Total Revenue</div>
									<div class="h5 mb-0 font-weight-bold text-gray-800">
										GH₵<?= number_format($stats['total_revenue'] ?? 0, 2) ?></div>
								</div>
								<div class="col-auto">
							...
							<div class="list-group list-group-flush">
								...
								<div class="list-group-item d-flex justify-content-between align-items-center px-0">
									...
									<div class="text-right">
										<span class="badge bg-primary rounded-pill"><?= $advertiser['booking_count'] ?>
											bookings</span>
										<br>
										<small
											class="text-muted">GH₵<?= number_format($advertiser['total_spent'], 2) ?></small>
									</div>
								</div>
								<?php endforeach; ?>
							</div>
