            ...
            <div class="card-body">
                <form id="generalSettingsForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="siteDescription" rows="3">Professional radio advertisement booking system</textarea>
                    </div>
                    <div class="mb-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="bookingSettingsForm">
                    ...
                    <div class="mb-3">
                        <label for="cancellationDeadline" class="form-label">Cancellation Deadline (hours before slot)</label>
            ...
            <div class="card-body">
                <form id="notificationSettingsForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="notificationEmail" placeholder="admin@zaaradio.com">
                    </div>
                    <div class="mb-3">
...
function populateSettings(settings) {
    ...
    if (settings.security) {
        ...
        document.getElementById('requireEmailVerification').checked = settings.security.require_email_verification || true;
