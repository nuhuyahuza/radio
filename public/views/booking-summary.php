					...
					<div class="summary-card p-5">
						...
						<div id="draftContent" style="display:none">
							<div class="info-card">
								...
								<div class="d-flex justify-content-between"><span>Date</span><span
										id="draftDate"></span></div>
								<div class="d-flex justify-content-between"><span>Time</span><span
										id="draftTime"></span></div>
								<div class="d-flex justify-content-between"><span>Station</span><span
										id="draftStation">Zaa Radio</span></div>
								<div class="d-flex justify-content-between"><span>Total</span><span
										class="price-highlight" id="draftTotal"></span></div>
							</div>

							<div class="info-card">
								<h6><i class="fas fa-user me-2"></i>Advertiser</h6>
								<div class="d-flex justify-content-between"><span>Name</span><span
										id="draftName"></span></div>
								<div class="d-flex justify-content-between"><span>Email</span><span
										id="draftEmail"></span></div>
								<div class="d-flex justify-content-between"><span>Phone</span><span
										id="draftPhone"></span></div>
								<div class="d-flex justify-content-between"><span>Company</span><span
										id="draftCompany"></span></div>
							</div>
					...
					try {
						const resp = await fetch('/booking/confirm', {
							...
							headers: {
								...
								'X-CSRF-Token': getCookie('XSRF-TOKEN') || (csrfInput ? csrfInput
									.value : '')
							}
						});
						...
						if (contentType.includes('application/json')) {
							...
							if (data.success) {
								...
								showAlert(data.message || 'Confirmation failed. Please try again.',
									'error');
							}
							return;
						}
